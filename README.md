...
- GANs popular research topics inlcude: objective function (vanilla / orginal / standard GANs 2014.06 --> Least-Square-GANs 2016.11 --> WGANs 2017.01 --> WGANs-GP 2017.04 --> my arXiv report (https://arxiv.org/abs/1807.00751) 2018.07 --> LGANs 2019.02); network architecture (Laplace GAN 2015.06 --> DCGAN 2015.11 --> Progressive Growing GANs 2017.10 --> Self Attension GANs 2018.05 --> BigGANs 2018.09 --> BigBigGANs 2019.07); optimization (Unrolled 2016.11 --> The Numerics of GANs 2017.05 --> optimization is locally stable 2017.06 and Two Time Scale 2017.06 --> Training gans with optimism 2017.11 --> Which do actually converge? 2018.01) , generalization / sub-optimum analysis (Generalization and Equilibrium in GANs 2017.03 --> Dual-Framework-GANs 2018 nips --> ); appplication (diverse colorization 2017.02, cycle gans 2017.03, ot-cylce gans 2018.11, my arXiv report https://arxiv.org/abs/2003.06635). 

- I personally do not follow the optimization path, because I don't think the key problem lies in optimization. Until Adam is shown to not guarantee its convergence, we then have a work AdaShfit to solve the non-convergence issue of Adam. 
